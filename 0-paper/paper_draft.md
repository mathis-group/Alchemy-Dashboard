...
- There are 4 visualization plots that this dashboard generates
  ...
  We also included a multi dendrogram tool that allows users to compare the evolution of expressions across various experiments utilizing the levenstein distance formula    
#### Implementation
##### Dashboard Structure
